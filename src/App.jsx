      ...
      <div className="container mx-auto px-4 py-16">
        {type === 'trade' ? renderTradeSuccess() : (
          <div className="text-center max-w-2xl mx-auto">
            <div className="htk-card mb-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-htk-gold rounded-full flex items-center justify-center mx-auto mb-6">
                  <svg className="w-8 h-8 text-htk-black" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                </div>
                <h1 className="text-3xl font-bold htk-gold-text mb-4">Job Request Submitted!</h1>
                <p className="text-htk-platinum/90 mb-6 text-lg">
                  Thank you for choosing HTK. Your job request has been received and we're already working to connect you with the best tradespeople in your area.
                </p>
                
                <div className="bg-htk-charcoal p-6 rounded-lg mb-6">
                  <h3 className="htk-gold-text font-semibold mb-3">What happens next?</h3>
                  <div className="space-y-2 text-left">
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-htk-gold rounded-full mr-3"></div>
                      <span className="text-htk-platinum/80">We'll review your job requirements</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-htk-gold rounded-full mr-3"></div>
                      <span className="text-htk-platinum/80">Match you with verified tradespeople in your area</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-htk-gold rounded-full mr-3"></div>
                      <span className="text-htk-platinum/80">Send you profiles within 24 hours</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-htk-gold rounded-full mr-3"></div>
                      <span className="text-htk-platinum/80">You choose who to work with - no commission fees!</span>
                    </div>
                  </div>
                </div>
                
                <p className="text-htk-platinum/70 mb-6">
            ...
            <div className="space-x-4">
              ...
              <Link to="/how-it-works">
                <Button className="htk-button-secondary">Learn More</Button>
              </Link>
            </div>
          </div>
        )}
...
function ReviewsPage() {
  ...
  const handleSubmitReview = (e) => {
    ...
    alert('Thank you for your review! It will be verified and published shortly.')
  }
  ...
  const renderStars = (rating) => {
    return Array.from({ length: 5 }, (_, i) => (
      <Star
        key={i}
        className={`w-4 h-4 ${i < rating ? 'text-htk-gold fill-current' : 'text-htk-platinum/30'}`}
      />
    ))
  }
  ...
  return (
    <div className="htk-bg-primary min-h-screen">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold htk-gold-text mb-4">Customer Reviews</h1>
          <p className="text-htk-platinum/80 text-lg max-w-2xl mx-auto">
            Real reviews from real customers. See what others are saying about our verified tradespeople.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto mb-12">
          <Card className="htk-card">
            <CardHeader>
              <CardTitle className="htk-gold-text">Leave a Review</CardTitle>
              <CardDescription className="text-htk-platinum/70">
                Share your experience with a tradesperson
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmitReview} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label className="htk-gold-text">Your Name</Label>
                    <Input
                  ...
                  <div>
                    <Label className="htk-gold-text">Tradesperson/Business</Label>
                    <Input
                      value={newReview.tradeName}
                      onChange={(e) => setNewReview({...newReview, tradeName: e.target.value})}
                ...
                <div>
                  <Label className="htk-gold-text">Job Type</Label>
                  <Input
                    value={newReview.jobType}
                    onChange={(e) => setNewReview({...newReview, jobType: e.target.value})}
                    placeholder="e.g., Bathroom Installation, Electrical Work"
                    className="htk-input"
                    required
                  />
                </div>
                ...
                <div>
                  <Label className="htk-gold-text">Rating</Label>
                  <div className="flex space-x-1 mt-2">
                    {Array.from({ length: 5 }, (_, i) => (
                      ...
                      >
                        <Star
                          className={`w-6 h-6 ${i < newReview.rating ? 'text-htk-gold fill-current' : 'text-htk-platinum/30'}`}
                        />
                      </button>
                    ))}
                  </div>
                ...
                <div>
                  <Label className="htk-gold-text">Your Review</Label>
                  <Textarea
                    value={newReview.comment}
                    onChange={(e) => setNewReview({...newReview, comment: e.target.value})}
                    placeholder="Tell others about your experience..."
                    className="htk-input min-h-[100px]"
                    required
                  />
                </div>

                <Button type="submit" className="htk-button-primary w-full">
                  Submit Review
                </Button>
              </form>
            </CardContent>
        ...
        {/* Reviews List */}
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold htk-gold-text mb-6">Recent Reviews</h2>
          <div className="space-y-6">
            {reviews.map((review) => (
              <Card key={review.id} className="htk-card">
                <CardContent className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h3 className="font-semibold htk-gold-text">{review.tradeName}</h3>
                      <p className="text-htk-platinum/70 text-sm">{review.jobType}</p>
                    </div>
                    <div className="text-right">
                      <div className="flex space-x-1 mb-1">
                        {renderStars(review.rating)}
                      </div>
                      <p className="text-htk-platinum/60 text-xs">{review.date}</p>
                    </div>
                  </div>
                  
                  <p className="text-htk-platinum/90 mb-3">"{review.comment}"</p>
                  
                  <div className="flex justify-between items-center">
                    <p className="text-htk-platinum/70 text-sm">- {review.customerName}</p>
                    {review.verified && (
                      <Badge className="htk-badge-gold text-xs">
                        ✓ Verified Customer
                      </Badge>
                    )}
                  </div>
...
function CollaborationsPage() {
  const [collaborations, setCollaborations] = useState([
    {
      id: 1,
      title: "Kitchen & Bathroom Renovation Team",
      trades: ["Plumber", "Electrician", "Tiler", "Carpenter"],
      location: "London, SW",
      description: "Experienced team specializing in complete kitchen and bathroom renovations. We work together regularly and offer competitive package deals.",
      contactTrade: "Mike's Plumbing Services",
      rating: 4.9,
      completedJobs: 47,
      featured: true
    },
    {
      id: 2,
      title: "House Extension Specialists",
      trades: ["Builder", "Electrician", "Plumber", "Roofer"],
      location: "Manchester",
      description: "Complete house extension service from foundation to finish. Our collaborative approach ensures seamless project delivery.",
      contactTrade: "Northern Builders Ltd",
      rating: 4.8,
      completedJobs: 23,
      featured: false
    },
    {
      id: 3,
      title: "Commercial Fit-Out Team",
      trades: ["Electrician", "Carpenter", "Painter", "Flooring Specialist"],
      location: "Birmingham",
      description: "Specialized in office and retail fit-outs. Fast, efficient, and professional service for commercial clients.",
      contactTrade: "Midlands Commercial Services",
      rating: 4.7,
      completedJobs: 31,
      featured: false
    }
  ...
  const handleSubmitCollaboration = (e) => {
    e.preventDefault()
    const collaboration = {
      id: collaborations.length + 1,
      ...newCollaboration,
      trades: newCollaboration.trades.split(',').map(t => t.trim()),
      rating: 0,
      completedJobs: 0,
      featured: false
    }
    ...
    setShowForm(false)
    alert('Your collaboration has been submitted! It will be reviewed and published shortly.')
  }
  ...
  return (
    <div className="htk-bg-primary min-h-screen">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold htk-gold-text mb-4">Trade Collaborations</h1>
          <p className="text-htk-platinum/80 text-lg max-w-2xl mx-auto">
            Discover established trade teams and collaborative partnerships. Better results through teamwork.
          </p>
        </div>
        ...
        <div className="text-center mb-8">
          <Button 
            ...
            className="htk-button-primary"
          >
            {showForm ? 'Cancel' : 'Create New Collaboration'}
          </Button>
        </div>
        ...
        {showForm && (
          <div className="max-w-2xl mx-auto mb-12">
            <Card className="htk-card">
              <CardHeader>
                <CardTitle className="htk-gold-text">Create Trade Collaboration</CardTitle>
                <CardDescription className="text-htk-platinum/70">
                  Partner with other trades to offer comprehensive services
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmitCollaboration} className="space-y-4">
                  <div>
                    <Label className="htk-gold-text">Collaboration Title</Label>
                    <Input
                      value={newCollaboration.title}
                      onChange={(e) => setNewCollaboration({...newCollaboration, title: e.target.value})}
                      placeholder="e.g., Complete Bathroom Renovation Team"
                      className="htk-input"
                      required
                    />
                  </div>
                  ...
                  <div>
                    <Label className="htk-gold-text">Trades Involved</Label>
                    <Input
                      value={newCollaboration.trades}
                      onChange={(e) => setNewCollaboration({...newCollaboration, trades: e.target.value})}
                      placeholder="e.g., Plumber, Electrician, Tiler (comma separated)"
                      className="htk-input"
                      required
                    />
                  </div>
                  ...
                  <div>
                    <Label className="htk-gold-text">Location</Label>
                    <Input
                  ...
                  <div>
                    <Label className="htk-gold-text">Contact Trade/Business</Label>
                    <Input
                      value={newCollaboration.contactTrade}
                      onChange={(e) => setNewCollaboration({...newCollaboration, contactTrade: e.target.value})}
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="Describe your collaboration, services offered, and what makes your team special..."
                      className="htk-input min-h-[100px]"
                      required
                    />
                  </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold htk-gold-text">Active Collaborations</h2>
            <Badge className="htk-badge-gold">
              {collaborations.length} Teams Available
            </Badge>
          </div>
          
          <div className="space-y-6">
            {collaborations.map((collab) => (
              <Card key={collab.id} className={`htk-card ${collab.featured ? 'border-htk-gold' : ''}`}>
                <CardContent className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <h3 className="font-semibold htk-gold-text text-lg">{collab.title}</h3>
                        {collab.featured && (
                          <Badge className="htk-badge-gold text-xs">Featured</Badge>
                        )}
                      </div>
                      <p className="text-htk-platinum/70 text-sm mb-2">📍 {collab.location}</p>
                      <div className="flex flex-wrap gap-2 mb-3">
                        {collab.trades.map((trade, index) => (
                    ...
                    <div className="text-right">
                      {collab.rating > 0 && (
                        <div className="flex items-center gap-1 mb-1">
                          ...
                          <span className="text-htk-gold font-semibold">{collab.rating}</span>
                        </div>
                      )}
                      <p className="text-htk-platinum/60 text-xs">{collab.completedJobs} jobs completed</p>
                    </div>
                  </div>
                  
                  <p className="text-htk-platinum/90 mb-4">{collab.description}</p>
                  
                  <div className="flex justify-between items-center">
                    <p className="text-htk-platinum/70 text-sm">Contact: {collab.contactTrade}</p>
                    <Button className="htk-button-secondary">
                      Get Quote
                    </Button>
                  </div>
        ...
        <div className="text-center mt-12">
          <Card className="htk-card max-w-2xl mx-auto">
            <CardContent className="p-8">
              <h3 className="text-xl font-bold htk-gold-text mb-4">Want to Start a Collaboration?</h3>
              <p className="text-htk-platinum/80 mb-6">
                Team up with other skilled tradespeople to offer comprehensive services and win bigger projects.
              </p>
