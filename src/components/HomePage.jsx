    ...
    <div className="htk-bg-primary">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-htk-platinum/80 mb-8">The premium community-first platform connecting skilled professionals with customers. Zero commission fees. Fair pricing. Community profit sharing.</p>
          <div>
